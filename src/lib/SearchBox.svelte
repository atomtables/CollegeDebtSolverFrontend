...
<dialog
    id="searchDialog"
    class="modal modal-top max-w-2xl place-items-center m-auto mb-48"
    bind:this={search}
>
    <div class="modal-box rounded-2xl">
        <h3 class="font-bold text-lg">Search for stock symbols</h3>
        <p>
            Search for any stock symbol you want! (A stock symbol is usually 2-6
            letters, like AAPL)
        </p>
        ...
        <br />
        <ul
            class="menu bg-base-200 rounded-box overflow-scroll max-h-72 w-full"
        >
